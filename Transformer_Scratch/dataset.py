...
class BiLingualDataSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # sos and eos with padding if need to src text
        ...
        return {
            ...
            "encoder_mask": (encoder_input != self.pad_token).unsqueeze(0).unsqueeze(0).int(), # (1,1,seq_len) will be used in self attention mech
